...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Guest</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a  href="{{ route('guest.password.request') }}">I forgot my password</a><br>
    <a href="{{ route('guest.register') }}" class="text-center">Register a new membership</a>
