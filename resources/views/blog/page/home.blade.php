	...
	@foreach ($posts as $post)
		<article>
            <div class="post-image">
                <a href="{!! asset('blog/post/') !!}{!!'/'.$post->slug!!}" title=""><img src="{{ $post->thumbnail }}" alt="{{ $post->title }}"></a>
